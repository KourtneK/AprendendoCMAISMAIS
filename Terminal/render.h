...
struct Renderizador
{
    ...
    SDL_Texture* terminalTexture = nullptr;
    ...
    void loadTextures()
    {
        ...
        terminalTexture = SDL_CreateTextureFromSurface(render, surfaceSquare);
        fontTexture = SDL_CreateTextureFromSurface(render, surfaceWall);
    ...
    void drawWalls(const std::vector<SDL_FRect>& paredes)
    {
        ...
        {
            SDL_RenderTexture(render, fontTexture, NULL, &parede);
        }
    }
    ...
    void drawSquare(const SDL_FRect& rect)
    {
        if (terminalTexture)
        {
            SDL_RenderTexture(render, terminalTexture, NULL, &rect);
        }
        else 
        {
